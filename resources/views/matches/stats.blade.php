            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-slate-100 bg-slate-50 text-slate-500 text-xs font-bold uppercase tracking-wider">
                        ...
                        <th class="py-4 px-6 text-center w-32">Gol (Goals)</th>
                        <th class="py-4 px-6 text-center w-32">Assist</th>
                        <th class="py-4 px-6 text-center w-32">Kartu Kuning</th>
                        <th class="py-4 px-6 text-center w-32">Kartu Merah</th>
                        <th class="py-4 px-6 text-center w-40">Menit Bermain</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-slate-50/70 transition-colors">
                            ...
                            <td class="py-4 px-6 text-center">
                                <input type="number" name="stats[{{ $p->id }}][goals]" value="{{ $goals }}" min="0" required
                                    class="w-20 bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 text-center text-slate-900 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 font-bold transition-all">
                            </td>
                            ...
                            <td class="py-4 px-6 text-center">
                                <select name="stats[{{ $p->id }}][yellow_cards]" required
                                    class="w-20 bg-slate-50 border border-slate-200 rounded-xl px-2 py-1.5 text-center text-slate-900 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 text-xs font-bold transition-all">
                            ...
                            <td class="py-4 px-6 text-center">
                                <div class="inline-flex items-center gap-1.5">
                                    <input type="number" name="stats[{{ $p->id }}][minutes_played]" value="{{ $minutes }}" min="0" max="100" required
                                        class="w-20 bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 text-center text-slate-900 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 font-bold transition-all">
                                    <span class="text-xs text-slate-450 font-bold">Min</span>
                                </div>
                            </td>
                        </tr>
                    @empty
